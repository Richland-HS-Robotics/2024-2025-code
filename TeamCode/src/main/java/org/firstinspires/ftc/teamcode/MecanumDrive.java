...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 115.0 / 6292.0; // 115 in, 6292 ticks
        public double lateralInPerTick = 111.5 / 4875.0; // 111.5 in, 4875 ticks
        public double trackWidthTicks =  1053.9900893249912;

        // feedforward parameters (in tick units)
        public double kS = 0.39504578325773654;
        public double kV = 0.004394849107546279;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        try{
            ...
            //hardwareMap.tryGet(DcMotorEx.class, "leftFront");
        }catch (Exception e){
            disabled = true;
